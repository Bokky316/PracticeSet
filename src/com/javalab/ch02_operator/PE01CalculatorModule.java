...
- 제한 : non-static 멤버에 직접 접근할 수 없음, this 키워드를 사용할 수 없음
 */
...
- public
- private
- static : 클래스가 로드되는 순간 접근 가능. (정적 메소드)
- double : 반환 타입
(void : 반환 타입 없음 _ 코드만 실행하고 끝! 반환할 것이 없음)
- add : 메소드
- (double a, double b) : 매개변수 (외부에서 add 호출하며 값 받아줌)
- return : 값 반환->호출한 곳으로

Scanner scanner = new Scanner(System.in);
- Scanner(1) : class
- scanner : 객체_값을 여러개 가짐
- new : 메소드
- Scanner(2) : 생성자
 */